...
export class Stelo extends ethereum.SmartContract {
  static bind(address: Address): Stelo {
    return new Stelo("Stelo", address);
  }
  ...
  TOKENS_PER_AUCTION(): BigInt {
    let result = super.call(
      "TOKENS_PER_AUCTION",
      "TOKENS_PER_AUCTION():(uint256)",
      []
    );
  ...
  try_TOKENS_PER_AUCTION(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "TOKENS_PER_AUCTION",
      "TOKENS_PER_AUCTION():(uint256)",
      []
  ...
  getCurrentAuctionId(): BigInt {
    let result = super.call(
      "getCurrentAuctionId",
      "getCurrentAuctionId():(uint256)",
      []
    );
  ...
  try_getCurrentAuctionId(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getCurrentAuctionId",
      "getCurrentAuctionId():(uint256)",
      []
  ...
  lastAuctionSellPrice(): BigInt {
    let result = super.call(
      "lastAuctionSellPrice",
      "lastAuctionSellPrice():(uint256)",
      []
    );
  ...
  try_lastAuctionSellPrice(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "lastAuctionSellPrice",
      "lastAuctionSellPrice():(uint256)",
      []
...
export class ParticipateInAuctionCall extends ethereum.Call {
  get inputs(): ParticipateInAuctionCall__Inputs {
    return new ParticipateInAuctionCall__Inputs(this);
  }

  get outputs(): ParticipateInAuctionCall__Outputs {
    return new ParticipateInAuctionCall__Outputs(this);
  }
}

export class ParticipateInAuctionCall__Inputs {
  _call: ParticipateInAuctionCall;

  constructor(call: ParticipateInAuctionCall) {
    this._call = call;
  }
}

export class ParticipateInAuctionCall__Outputs {
  _call: ParticipateInAuctionCall;
