...
export class SettedUp extends ethereum.Event {
  get params(): SettedUp__Params {
    return new SettedUp__Params(this);
  }
}

export class SettedUp__Params {
  _event: SettedUp;

  constructor(event: SettedUp) {
    this._event = event;
  }
