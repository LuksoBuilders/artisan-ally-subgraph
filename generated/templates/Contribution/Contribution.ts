...
export class Purified extends ethereum.Event {
  get params(): Purified__Params {
    return new Purified__Params(this);
  }
}

export class Purified__Params {
  _event: Purified;

  constructor(event: Purified) {
    this._event = event;
  }
...
export class Contribution extends ethereum.SmartContract {
  ...
  _contributionHistory(param0: Address): BigInt {
    let result = super.call(
      "_contributionHistory",
      "_contributionHistory(address):(uint256)",
  ...
  try__contributionHistory(param0: Address): ethereum.CallResult<BigInt> {
  ...
  try__divineDungDepot(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "_divineDungDepot",
      "_divineDungDepot():(address)",
      []
  ...
  _holyShit(): Address {
    let result = super.call("_holyShit", "_holyShit():(address)", []);

    return result[0].toAddress();
  }

  try__holyShit(): ethereum.CallResult<Address> {
    let result = super.tryCall("_holyShit", "_holyShit():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class PurifyCall extends ethereum.Call {
  get inputs(): PurifyCall__Inputs {
    return new PurifyCall__Inputs(this);
  }

  get outputs(): PurifyCall__Outputs {
    return new PurifyCall__Outputs(this);
  }
}

export class PurifyCall__Inputs {
  _call: PurifyCall;

  constructor(call: PurifyCall) {
    this._call = call;
  }
...
export class PurifyCall__Outputs {
  _call: PurifyCall;
