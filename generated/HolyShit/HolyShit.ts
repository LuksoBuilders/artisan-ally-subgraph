...
export class HolyShit extends ethereum.SmartContract {
  static bind(address: Address): HolyShit {
    return new HolyShit("HolyShit", address);
  }

  LAST_POSSIBLE_MINT_BEFORE(): BigInt {
    let result = super.call(
      "LAST_POSSIBLE_MINT_BEFORE",
      "LAST_POSSIBLE_MINT_BEFORE():(uint256)",
      []
    );
  ...
  try_LAST_POSSIBLE_MINT_BEFORE(): ethereum.CallResult<BigInt> {
  ...
  SHIT_COOLDOWN(): BigInt {
    let result = super.call("SHIT_COOLDOWN", "SHIT_COOLDOWN():(uint256)", []);

    return result[0].toBigInt();
  }

  try_SHIT_COOLDOWN(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "SHIT_COOLDOWN",
      "SHIT_COOLDOWN():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  apexDeities(): Address {
    let result = super.call("apexDeities", "apexDeities():(address)", []);

    return result[0].toAddress();
  }

  try_apexDeities(): ethereum.CallResult<Address> {
    let result = super.tryCall("apexDeities", "apexDeities():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  lastShitTime(param0: Bytes): BigInt {
    let result = super.call("lastShitTime", "lastShitTime(bytes32):(uint256)", [
  ...
  try_lastShitTime(param0: Bytes): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "lastShitTime",
      "lastShitTime(bytes32):(uint256)",
      [ethereum.Value.fromFixedBytes(param0)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  shitPerCyclePerTier(tier: i32): BigInt {
    let result = super.call(
      "shitPerCyclePerTier",
      "shitPerCyclePerTier(uint8):(uint256)",
  ...
  try_shitPerCyclePerTier(tier: i32): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "shitPerCyclePerTier",
      "shitPerCyclePerTier(uint8):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(tier))]
...
export class ConstructorCall__Inputs {
  ...
  get apexDeitiesAddress(): Address {
...
export class BatchShitCall extends ethereum.Call {
  get inputs(): BatchShitCall__Inputs {
    return new BatchShitCall__Inputs(this);
  }

  get outputs(): BatchShitCall__Outputs {
    return new BatchShitCall__Outputs(this);
  }
}

export class BatchShitCall__Inputs {
  _call: BatchShitCall;

  constructor(call: BatchShitCall) {
    this._call = call;
  }
...
export class BatchShitCall__Outputs {
  _call: BatchShitCall;
...
export class ShitCall extends ethereum.Call {
  get inputs(): ShitCall__Inputs {
    return new ShitCall__Inputs(this);
  }

  get outputs(): ShitCall__Outputs {
    return new ShitCall__Outputs(this);
  }
}

export class ShitCall__Inputs {
  _call: ShitCall;

  constructor(call: ShitCall) {
    this._call = call;
  }
...
export class ShitCall__Outputs {
  _call: ShitCall;
